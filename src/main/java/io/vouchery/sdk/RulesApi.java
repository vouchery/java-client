...
public class RulesApi {
     ...
     */
    public okhttp3.Call createRuleCall(Integer campaignId, Rule rule, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call createRuleValidateBeforeCall(Integer campaignId, Rule rule, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = createRuleCall(campaignId, rule, _callback);
        return localVarCall;
     ...
     */
    public Rule createRule(Integer campaignId, Rule rule) throws ApiException {
        ApiResponse<Rule> localVarResp = createRuleWithHttpInfo(campaignId, rule);
     ...
     */
    public ApiResponse<Rule> createRuleWithHttpInfo(Integer campaignId, Rule rule) throws ApiException {
        okhttp3.Call localVarCall = createRuleValidateBeforeCall(campaignId, rule, null);
     ...
     */
    public okhttp3.Call createRuleAsync(Integer campaignId, Rule rule, final ApiCallback<Rule> _callback) throws ApiException {

        okhttp3.Call localVarCall = createRuleValidateBeforeCall(campaignId, rule, _callback);
        Type localVarReturnType = new TypeToken<Rule>(){}.getType();
     ...
     */
    public okhttp3.Call updateRuleCall(Integer id, Rule rule, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = rule;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call updateRuleValidateBeforeCall(Integer id, Rule rule, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = updateRuleCall(id, rule, _callback);
        return localVarCall;
     ...
     */
    public Rule updateRule(Integer id, Rule rule) throws ApiException {
        ApiResponse<Rule> localVarResp = updateRuleWithHttpInfo(id, rule);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<Rule> updateRuleWithHttpInfo(Integer id, Rule rule) throws ApiException {
        okhttp3.Call localVarCall = updateRuleValidateBeforeCall(id, rule, null);
        Type localVarReturnType = new TypeToken<Rule>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call updateRuleAsync(Integer id, Rule rule, final ApiCallback<Rule> _callback) throws ApiException {

        okhttp3.Call localVarCall = updateRuleValidateBeforeCall(id, rule, _callback);
        Type localVarReturnType = new TypeToken<Rule>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
