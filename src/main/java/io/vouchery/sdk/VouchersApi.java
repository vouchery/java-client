...
public class VouchersApi {
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> Expired voucher </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call expireVoucherCall(String code, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;

        // create path and map variables
        String localVarPath = "/vouchers/{code}/expire"
            .replaceAll("\\{" + "code" + "\\}", localVarApiClient.escapeString(code.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call expireVoucherValidateBeforeCall(String code, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'code' is set
        if (code == null) {
            throw new ApiException("Missing the required parameter 'code' when calling expireVoucher(Async)");
        }
        

        okhttp3.Call localVarCall = expireVoucherCall(code, _callback);
        return localVarCall;
     ...
     */
    public Voucher expireVoucher(String code) throws ApiException {
        ApiResponse<Voucher> localVarResp = expireVoucherWithHttpInfo(code);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<Voucher> expireVoucherWithHttpInfo(String code) throws ApiException {
        okhttp3.Call localVarCall = expireVoucherValidateBeforeCall(code, null);
        Type localVarReturnType = new TypeToken<Voucher>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Expire a voucher (asynchronously)
     * Expire a voucher
     * @param code Voucher code (required)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
     ...
     */
    public okhttp3.Call expireVoucherAsync(String code, final ApiCallback<Voucher> _callback) throws ApiException {

        okhttp3.Call localVarCall = expireVoucherValidateBeforeCall(code, _callback);
        Type localVarReturnType = new TypeToken<Voucher>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
