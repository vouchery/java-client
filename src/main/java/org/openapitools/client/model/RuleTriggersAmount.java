...
public class RuleTriggersAmount {
  ...
  private TypeEnum type = TypeEnum.TRIGGERS_AMOUNT;
   ...
   * @return type
  **/
  @ApiModelProperty(required = true, value = "Number of triggers, triggering the subcampaign, should match specific condition.")
